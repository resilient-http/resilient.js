...
A **browser** and **[node](http://nodejs.org)**/[io.js](htps://iojs.org) highly **configurable** and **full featured HTTP client** with **superpowers** such as **fault tolerance**, **dynamic servers discovery**, transparent server **fallback**, **request retry** cycles, built-in **balancer**, round-robin scheduling for better **load distribution** and [more](#features)...
...
```html
<script src="//cdn.rawgit.com/resilient-http/resilient.js/0.2.27/resilient.js"></script>
```
