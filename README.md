...
**[Middleware](#middleware-layer)-oriented**, evented-based, **full featured HTTP client** for **[node.js](http://nodejs.org)** and **browsers** with **superpowers** such as **fault tolerance** with transparent server **fallback**, **dynamic servers lookup**, **request retry**/**backoff**, built-in **balancer** and [more](#features)...
